...
class DingTalkRobotUtil
{
    ...
    const TOKEN_ADD_ACCOUNT = '856507e908cfbf21ecdeb885cf2d96a8b8cf74dfd98394b1a18f33b81d80cbfb';
    const TOKEN_REFRESH_TASK_STATUS = '8348d36977213f50b64066e08e62dedc7f815ef1c1af3fc6b2f4fdde342ef0f1';
    ...
    {
        get_instance()->config->load('api_config');
        $java_auth_api = get_instance()->config->item('java_auth_api');
        //if (PHP_OS != 'Linux' || ENVIRONMENT != 'production') {
        if (PHP_OS != 'Linux' || $java_auth_api['user_name'] != 'prod_accountcenter') {
